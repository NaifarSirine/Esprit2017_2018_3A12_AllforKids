...
//     PGS.supprimerCompte(PG1);
      // System.out.println(PGS.consulterCompte(7).toString());
//        EvaluationGarderie E=new EvaluationGarderie(0,15,7,1);
...
//        DemandeAjoutGarderie D=new DemandeAjoutGarderie(0,"hello","hello2", EtatDemandeAjout.EnTraitement,7,1);
...
//        DAS.modifierEtat(2, EtatDemandeAjoutGarderie.EnTraitement);
        List<DemandeAjoutGarderie> Liste= DAS.consulterDGarderie(7);
         for(DemandeAjoutGarderie DAG1:Liste)
       {
           System.out.println(DAG1.toString());
       }
//       Garderie G=new Garderie(0,"test","test","test","test","test","test","test",7,"tunis");
//        Garderie G1=new Garderie(1,"test","testallo","test","test","test","test","test",7,"Bizerte");
